...
class WeatherDataProcessor:
    """
    A class to process weather data including message parsing and calculation of mean values.

    Attributes:
    - config_params (dict): A dictionary containing configuration parameters including weather CSV path and regex patterns.
    - logging_level (str): The logging level to be used (default is "INFO").
    """
    ...
    def initialize_logging(self, logging_level):
        ...
        Parameters:
        - logging_level (str): The logging level to be used.
        """
    ...
    def weather_station_mapping(self):
        """
        Load weather station data from the web CSV file.
        """
    ...
    def extract_measurement(self, message):
        ...
        Parameters:
        - message (str): The message from which measurements need to be extracted.

        Returns:
        - measurement (str): The type of measurement extracted.
        - value (float): The value of the measurement extracted.
        """
    ...
    def calculate_means(self):
        """
        Calculate mean values of measurements grouped by weather station ID.

        Returns:
        - means (DataFrame): DataFrame containing mean values of measurements.
        """
        if self.weather_df is not None:
